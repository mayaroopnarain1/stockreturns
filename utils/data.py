...
SP500_TICKERS: list[str] = [
    ...
    "APH","APTV","ARE","ATO","AVB","AVGO","AVY","AWK","AXP","AZO","BA",
    ...
    "DD","DE","DFS","DG","DGX","DHI","DHR","DIS","DLR","DLTR","DOV","DOW",
    ...
    "FRT","FTNT","FTV","GD","GE","GILD","GIS","GL","GLW","GM","GNRC","GOOG",
    ...
    "SBUX","SCHW","SEE","SHW","SJM","SLB","SNA","SNPS","SO","SPG","SPGI",
